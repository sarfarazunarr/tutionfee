...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['email'])) {
        ...
        if ($user) {
            ...
            echo sendEmail($email, $username, "<p>Your OTP for reset password is: <strong>{$otp}</strong>. It will expire in 1 hour.</p>", "Reset Password OTP Request");
            displayToast($otp, 'success');
